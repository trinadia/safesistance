...
#include "model2.h" // Include your TensorFlow Lite model here
...
void loop() {
  ...
  normalizedData[0] = (a.acceleration.x / (accelerometerRange / 2.0));
  normalizedData[1] = (a.acceleration.y / (accelerometerRange / 2.0));
  normalizedData[2] = (a.acceleration.z / (accelerometerRange / 2.0));
  normalizedData[3] = (g.gyro.x / (gyroscopeRange / 2.0));
  normalizedData[4] = (g.gyro.y / (gyroscopeRange / 2.0));
  normalizedData[5] = (g.gyro.z / (gyroscopeRange / 2.0));
